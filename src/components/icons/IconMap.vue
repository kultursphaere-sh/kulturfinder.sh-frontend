<template>
  <g>
    <path class="primary" d="M3.3,3.9c-0.2-0.3-0.8,0-0.8-0.6c0-0.5,0.6-0.5,0.4-0.9c0.5-0.2,0.2-0.6-0.2-0.6c-0.8,0-1.2,1.9-1.2,2.4
    c0,0.3-0.2,1.5,0.3,1.7C2.3,6.1,2,4.5,2.2,4.4C2.5,4.9,3.6,4.4,3.3,3.9z"
    />
    <path class="primary" d="M23.1,9.2c-0.2-0.7-1.3-1.8-2.2-1.3c-0.3,0.1-0.5,0.7-0.4,1c0.1,0.4,0.4,0.4,0.4,0.4c0.1,0,0.1,0,0.2-0.1
    c0,0.3,0.2,0.4,0.4,0.5c0.1,0.1,0.3,0.1,0.5,0.1C22.3,9.8,23.3,9.7,23.1,9.2z"
    />
    <path class="primary" d="M20.9,9.7c-0.2-0.2-1,0.1-1.3,0.2c-0.2,0.1-0.2-0.1-0.5,0c-0.4,0.1-0.5,0.6-0.9,0.6c-0.1-0.5-1-0.8-1.5-1
