<template>
  <g>
    ...
    />
    <circle class="st0" cx="8.97" cy="3.99"
            r="0.87"
    />
    <circle class="st0" cx="6.37" cy="3.12"
            r="0.87"
    />
    <circle class="st0" cx="4.64" cy="5.72"
            r="0.87"
    />
    <circle class="st0" cx="14.17" cy="3.12"
            r="0.87"
    />
    <circle class="st0" cx="19.36" cy="3.99"
            r="0.87"
    />
    <circle class="st0" cx="16.76" cy="4.85"
            r="0.87"
    />
  </g>
</template>
